...
namespace Backend.Business_Logic_Layer
{
    public class JwtConfiguration
    {
        ...
        /// <summary>
        /// Gets or sets the timespan the token will be valid for (default is 15 min)
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets time span for RefreshToken valid for default value 1 day
        /// </summary>
        public TimeSpan RefreshTokenTimeSpan { get; set; } = TimeSpan.FromDays(1);
    }
}
