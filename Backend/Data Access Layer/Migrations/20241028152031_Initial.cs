    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CurrencyCode = table.Column<string>(type: "TEXT", maxLength: 5, nullable: false),
                    ActualDate = table.Column<DateOnly>(type: "TEXT", nullable: false),
                    CurrencyName = table.Column<string>(type: "TEXT", nullable: true),
                    BuyRateToBaseCurrency = table.Column<decimal>(type: "TEXT", nullable: false),
                    SellRateToBaseCurrency = table.Column<decimal>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Currencies", x => new { x.CurrencyCode, x.ActualDate });
                });
